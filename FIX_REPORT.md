...
- 首頁狀態列以 BTC／ETH 永續價格、24h 漲跌、Funding 與 OI 取代「衍生品背景／決策門檻」；近期事件與重要價位改為只露出兩筆的鍵盤可聚焦捲動區，並從首頁事件排除 Funding／OI 異常，完整衍生品頁仍保留。
...
- 本次首頁微調在桌面與 390×844、深／淺主題皆實測：BTC／ETH 卡片各一、事件與價位各只完整露出兩筆，且兩區均可捲到底查看更多；Funding／OI 異常不再出現在首頁事件。
